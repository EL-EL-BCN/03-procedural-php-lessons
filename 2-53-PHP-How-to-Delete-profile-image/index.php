...
<?php
			...
			while ($rowProfileImg = mysqli_fetch_assoc($resultSqlprofileImg)) {
				echo "<div class='user-container'>";
					if ($rowProfileImg['profileimg_status'] = 2) {
						echo "<img src='profile_images/profile".$user_id.".jpg?".mt_rand()."'>";
					} else {
	...
	if (isset($_SESSION['user_id'])) {
		...
		echo "<form action='includes/deleteprofile.inc.php' method='POST' enctype='multipart/form-data'>
		<button type='submit' name='submit'>DELETE PROFILE PIC</button>
	</form>";
	} else {
